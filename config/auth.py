...
class AuthController(ControllerBase):
    ...
    @route.post("/obtain", response=TokenObtainPairOutputSchema, url_name="auth_login")
    ...
    @route.post("/refresh", response=TokenRefreshOutputSchema, url_name="auth_refresh_token")
