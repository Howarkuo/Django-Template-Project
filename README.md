# Django Template
Ths is a Django template project for starting a new project for the FutureNest inc. team. Basically already setup the project structure, configurations, some required dependencies, and some useful tools for the development process.
