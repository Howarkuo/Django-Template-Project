...
class UserManager(DjangoUserManager, Manager):
    ...
    def _create_user_with_company_id(  # noqa: ANN202
        self,
        company_id: UUID,
        email: str,
        password: str | None,
        **extra_fields: dict,
        ...
        """Create user with company id private Manager method.

        Args:
            company_id (UUID): company id of the user.
    ...
    def create_user_with_company_id(
        self,
        company_id: UUID,
        email: str,
        ...
        **extra_fields: dict,
        ...
        """Create user with company id public Manager method.
        ...
        extra_fields.setdefault("is_staff", False)  # type: ignore
        extra_fields.setdefault("is_superuser", False)  # type: ignore
        return self._create_user_with_company_id(company_id, email, password, **extra_fields)
