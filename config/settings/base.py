...
from config.log_config.formatters import JsonFormatter
...
DEPLOYED_ON_ECS = os.environ.get("DEPLOYED_ON_ECS", default=False)
...
SERVER_PORT = int(os.environ.get("SERVER_PORT", default=8000))
...
db_secret_name = os.environ.get("DB_SECRET_NAME", default=None)
if db_secret_name:
    ...
    try:
        ...
        # TODO: Add error handling #noqa: TD002 FIX002
        raise e from e
    ...
    db_user = os.environ.get("POSTGRES_USER", default=None)
    db_password = os.environ.get("POSTGRES_PASSWORD", default=None)
    if db_user and db_password:
        DATABASES["default"]["USER"] = db_user
        DATABASES["default"]["PASSWORD"] = db_password
    else:
        raise ValueError("Please provide the database credentials")
...
MIDDLEWARE = [
    ...
    "config.log_config.middleware.APITimingMiddleware",
...
NINJA_JWT = {
    ...
    # FOR OBTAIN PAIR
    "TOKEN_OBTAIN_PAIR_INPUT_SCHEMA": "ainsight_backend.config.schemas.TokenObtainPairInputSchema",
    "TOKEN_OBTAIN_PAIR_REFRESH_INPUT_SCHEMA": "ainsight_backend.config.schemas.TokenRefreshInputSchema",
    # FOR SLIDING TOKEN
...
FEW_SHOT_EXAMPLE_TOP_SCORE_THRESHOLD = 0.5

SQL_AGENT_MAX_ITERATION = 10
SQL_AGENT_MAX_EXECUTION_TIME = 20.0

OAUTH_CLIENT_ID = os.environ.get("OAUTH_CLIENT_ID")
OAUTH_CLIENT_SECRET = os.environ.get("OAUTH_CLIENT_SECRET")
AUTH_REDIRECT_URL = os.environ.get("AUTH_REDIRECT_URL")

TEST_ACCOUNT_EMAIL = "alpaca@test.com"
TEST_ACCOUNT_PASSWORD = "test1234"  # noqa: S105

LINE_BOT_API_KEY = os.environ.get("LINE_BOT_API_KEY")
LINE_CHANNEL_SECRET = os.environ.get("LINE_CHANNEL_SECRET")
LINE_RICH_MENU_ID = os.environ.get("LINE_RICH_MENU_ID")
LINE_LOGIN_URL = os.environ.get("LINE_LOGIN_URL")
LINE_ID_ENCRYPT_KEY = os.environ.get("LINE_ID_ENCRYPT_KEY")

DATETIME_TIMEZONE = pytz.timezone(TIME_ZONE)
